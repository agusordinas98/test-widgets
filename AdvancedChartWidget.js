function executeWidgetCode() {
    require(['DS/DataDragAndDrop/DataDragAndDrop', 'lib/echarts'], function (DataDragAndDrop, echarts) {
        let myWidget = {
            ...
            initChart: function () {
                ...
                var option = {
                    title: {
                        text: 'Gráfico de Línea Apilado',
                        subtext: 'Datos Ficticios',
                        left: 'center'
                    },
                    tooltip: {
                        trigger: 'item',
                    ...
                    legend: {
                        orient: 'vertical',
                        left: 'left',
                        data: ['Email', 'Publicidad', 'Búsqueda Directa', 'Búsqueda Orgánica', 'Referidos']
                    },
                    xAxis: {
                        type: 'category',
                        boundaryGap: false,
